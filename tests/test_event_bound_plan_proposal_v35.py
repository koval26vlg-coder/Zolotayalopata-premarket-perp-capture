"""Contract for a non-authorizing event-bound v43 plan proposal."""
...
class EventBoundProposalTests(unittest.TestCase):
    ...
    def test_proposal_is_fixed_to_v43_but_cannot_activate_or_capture(self) -> None:
        ...
        self.assertEqual(proposal["proposed_plan_schema"], "premarket_perp_capture_planonly_v43")
        self.assertEqual(proposal["proposed_plan_id"], "premarket_perp_capture_20260822_v43")
        self.assertEqual(
    ...
    def test_crash_after_stage_archive_resumes_and_keeps_exact_archive(self) -> None:
        ...
        final = root / record["arming_id"] / (
            f"{record['revision']:020d}-{record['receipt_hash']}-v43-proposal.json"
        )
