...
class PaperOnlyLauncherNoCaptureTests(unittest.TestCase):
    ...
    def test_launcher_uses_the_active_v33_plan_and_never_delegates_to_legacy_v5(self) -> None:
        ...
        self.assertIn("premarket-perp-capture-planonly-20260822-v33.json", lowered)
