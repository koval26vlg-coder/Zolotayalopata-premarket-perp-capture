...
class PaperOnlyLauncherNoCaptureTests(unittest.TestCase):
    ...
    def test_launcher_uses_the_active_v34_plan_and_never_delegates_to_legacy_v5(self) -> None:
        ...
        self.assertIn("premarket-perp-capture-planonly-20260822-v34.json", lowered)
