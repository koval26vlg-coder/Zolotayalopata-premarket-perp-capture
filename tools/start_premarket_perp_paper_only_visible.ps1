...
$activePlan = Join-Path $projectRoot 'docs\plans\premarket-perp-capture-planonly-20260822-v33.json'
...
try {
    ...
    # v33 remains capture-disabled. Even when discovery later yields a human-reviewed
