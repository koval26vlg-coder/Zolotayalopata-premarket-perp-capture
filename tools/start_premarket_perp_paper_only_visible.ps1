...
$activePlan = Join-Path $projectRoot 'docs\plans\premarket-perp-capture-planonly-20260822-v32.json'
...
try {
    ...
    # v32 remains capture-disabled. Even when discovery later yields a human-reviewed
