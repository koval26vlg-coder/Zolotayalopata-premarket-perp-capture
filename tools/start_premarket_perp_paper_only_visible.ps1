...
$activePlan = Join-Path $projectRoot 'docs\plans\premarket-perp-capture-planonly-20260822-v38.json'
...
try {
    ...
    # v38 remains capture-disabled. Even when discovery later yields a human-reviewed
