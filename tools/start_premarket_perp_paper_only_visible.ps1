...
$activePlan = Join-Path $projectRoot 'docs\plans\premarket-perp-capture-planonly-20260822-v42.json'
...
try {
    ...
    # v42 remains capture-disabled. Even when discovery later yields a human-reviewed
