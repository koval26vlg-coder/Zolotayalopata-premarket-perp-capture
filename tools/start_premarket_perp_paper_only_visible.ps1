...
$activePlan = Join-Path $projectRoot 'docs\plans\premarket-perp-capture-planonly-20260822-v40.json'
...
try {
    ...
    # v40 remains capture-disabled. Even when discovery later yields a human-reviewed
